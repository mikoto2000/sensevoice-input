...
public class InjectionTests
{
    ...
    private sealed class FakeDesktop : IClipboardDesktop
    {
        ...
        public bool ChangeDuringPaste, FailPaste;
        public List<string> Calls = [];
        public bool IsTargetCurrent(nint target) => target == Foreground;
        public object Snapshot() { Calls.Add("snapshot"); return Content; }
        public void SetText(string text) { Calls.Add("set"); Content = text; Sequence++; }
        public void Paste(nint target) { Calls.Add("paste"); if (FailPaste) throw new IOException(); Pasted = Content; }
